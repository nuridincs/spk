...
# Generation Time: 2020-08-06 16:46:32 +0000
# ************************************************************
...
CREATE TABLE `karyawan` (
  ...
  `target_penjualan` char(3) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `jabatan` (`jabatan`),
  KEY `level` (`level`),
...
INSERT INTO `karyawan` (`id`, `nik`, `nama`, `jabatan`, `level`, `id_posisi`, `status`, `foto`, `doj`, `tgl_periode`, `target_penjualan`)
VALUES
	(2,'11000001','Marina',1,1,1,1,'profil1.jpg','0000-00-00 00:00:00','2019-06-11','90'),
	(3,'11000002','Dodi ',2,2,1,1,'profil1.jpg','2020-07-02 00:00:00','2019-06-11','70'),
	(4,'11000003','Tegar',3,3,1,1,'profil1.jpg','2020-07-02 00:00:00','2019-06-11','80'),
	(5,'11000004','Fitria',2,2,1,1,'profil1.jpg','2020-07-02 00:00:00','2019-06-11','100'),
	(6,'32423423','zibran',1,2,2,1,'profil1.jpg',NULL,'2018-06-11','75'),
	(8,'09099','test',1,2,1,1,'profil1.jpg',NULL,'2020-08-27','65'),
	(9,'112233','eva',1,NULL,2,1,'profil1.jpg',NULL,'2015-07-15','90');
