    ...
    <div class="row">
      <div class="col-sm-6">
        <div class="form-group">
          ...
          <input type="text" name="nc6" placeholder="Masukan Nilai Loyalitas" class="form-control" value="<?= $dataNilaiPegawai[0]->NC6 ?>" required>
        </div>
      </div>
      <div class="col-sm-6">
        <div class="form-group">
          ...
          foreach ($kriteria['dataC6'] as $c6) {
            if (!empty($dataNilaiPegawai)) {
              if ($c6->id === $dataNilaiPegawai[0]->bobot_id_c6) {
    ...
    <div class="row">
      <div class="col-sm-6">
        <div class="form-group">
          ...
          <input type="text" name="nc7" placeholder="Masukan Nilai Kepemimpinan" class="form-control" value="<?= $dataNilaiPegawai[0]->NC7 ?>" required>
        </div>
      </div>
      <div class="col-sm-6">
        <div class="form-group">
          ...
          foreach ($kriteria['dataC7'] as $c7) {
            if (!empty($dataNilaiPegawai)) {
              if ($c7->id === $dataNilaiPegawai[0]->bobot_id_c7) {
    ...
    <div class="row">
      <div class="col-sm-6">
        <div class="form-group">
          ...
          <input type="text" name="nc8" placeholder="Masukan Nilai Pendidikan" class="form-control" value="<?= $dataNilaiPegawai[0]->NC8 ?>" required>
        </div>
      </div>
      <div class="col-sm-6">
        <div class="form-group">
          ...
          foreach ($kriteria['dataC8'] as $c8) {
            if (!empty($dataNilaiPegawai)) {
              if ($c8->id === $dataNilaiPegawai[0]->bobot_id_c8) {
